...
#[test]
fn non_ip() {
    let result = core_parser(include_str!("non_ip.txt"));
...
fn invalid_ip_indent() {
    let result = core_parser(include_str!("invalid_ip_indent.txt"));
...
#[test]
fn empty_networks() {
    let result = core_parser(include_str!("empty_networks.txt"));
...
#[test]
fn invalid_type() {
    let result = core_parser(include_str!("invalid_type.txt"));
...
#[test]
fn duplicate_id() {
    let result = core_parser(include_str!("duplicate_id.txt"));
...
fn outoforder_duplicate_id() {
    let result = core_parser(include_str!("outoforder_duplicate_id.txt"));
