...
#[test]
fn no_applications() {
    let result = core_parser(include_str!("no_applications.txt"));
...
fn invalid_machine_indent() {
    let result = core_parser(include_str!("invalid_machine_indent.txt"));
...
fn invalid_network_declaration() {
    let result = core_parser(include_str!("invalid_network_declaration.txt"));
...
fn invalid_machine_declaration() {
    let result = core_parser(include_str!("invalid_machine_declaration.txt"));
...
fn invalid_networks_type() {
    let result = core_parser(include_str!("invalid_networks_type.txt"));
...
fn invalid_protocols_type() {
    let result = core_parser(include_str!("invalid_protocols_type.txt"));
...
fn invalid_applications_type() {
    let result = core_parser(include_str!("invalid_applications_type.txt"));
...
fn invalid_application_type() {
    let result = core_parser(include_str!("invalid_application_type.txt"));
...
fn invalid_network_args() {
    let result = core_parser(include_str!("invalid_network_args.txt"));
...
fn invalid_protocol_args() {
    let result = core_parser(include_str!("invalid_protocol_args.txt"));
